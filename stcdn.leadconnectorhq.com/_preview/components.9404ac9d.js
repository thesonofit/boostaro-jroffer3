import { u as p } from "./composables.52a41ef4.js";
import { d as a } from "./entry.1f1c7eda.js";
const S = (e) =>
...
a({
  ...
  setup: g((e, { slots: t }) => {
    var o;
    const n = { ...e },
      r = (((o = t.default) == null ? void 0 : o.call(t)) || [])
        .filter(({ children: i }) => i)
        .map(({ children: i }) => i)
        .join("");
...
a({
  name: "Base",
  inheritAttrs: !1,
  props: { ...s, href: String, target: String },
  setup: g((e) => ({ base: e })),
});
a({
  name: "Title",
  ...
  setup: g((e, { slots: t }) => {
    ...
    return {
      title:
        ((i =
          (o = (r = t.default) == null ? void 0 : r.call(t)) == null
            ? void 0
            : o[0]) == null
          ? void 0
          : i.children) || null,
...
const m = a({
  ...
  setup: g((e, { slots: t }) => {
    ...
    const n = { ...e },
      r =
        (l =
          (i = (o = t.default) == null ? void 0 : o.call(t)) == null
            ? void 0
            : i[0]) == null
          ? void 0
          : l.children;
...
a({
  ...
  setup: g((e) => ({ htmlAttrs: e }), !0),
});
a({
  name: "Body",
  inheritAttrs: !1,
  props: { ...s, renderPriority: [String, Number] },
  setup: g((e) => ({ bodyAttrs: e }), !0),
});
export { m as S };
